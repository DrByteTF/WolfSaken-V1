...
pcall(function()
    SprintingModule = require(ReplicatedStorage:WaitForChild("Systems", 5):WaitForChild("Character", 5):WaitForChild("Game", 5):WaitForChild("Sprinting", 5))
end)

local defaultLoss = SprintingModule and SprintingModule.StaminaLoss or 1
local defaultGain = SprintingModule and SprintingModule.StaminaGain or 1
...
local function getModule()
    ...
    return sprinting and require(sprinting) or nil
end
...
local function getKillersFolder()
    ...
    return players and players:FindFirstChild("Killers")
end

local function getSurvivorsFolder()
    local players = Workspace:FindFirstChild("Players")
    return players and players:FindFirstChild("Survivors")
end
...
task.spawn(function()
    while task.wait(1.5) do
        ...
        if ESPState.Killers and killers then
        ...
        if ESPState.Survivors and survivors then
            for _, s in pairs(survivors:GetChildren()) do
